...
const AICoPilot: React.FC<AICoPilotProps> = () => {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-7.5rem)] bg-white rounded-xl shadow-hard-sm border border-ledger overflow-hidden max-w-5xl mx-auto animate-enter">
