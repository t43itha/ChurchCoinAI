...
const pricingPlans: PricingPlan[] = [
  {
    ...
    name: "Starter",
    price: "£29",
    description: "For churches ready to keep everything together.",
    features: [
      "Up to 50 donors",
      "Gift Aid tracking",
      "Monthly reports",
  ...
  },
  {
    ...
    name: "Growing",
    price: "£59",
    description: "For established churches with more to manage.",
    features: [
      "Up to 200 donors",
      "Unlimited funds",
      "AI categorisation",
  ...
  },
  {
    ...
    name: "Thriving",
    price: "£99",
    description: "For multi-site churches and complex finances.",
    features: [
      "Unlimited donors",
      "Multi-site support",
      "Custom integrations",
