...
export const INITIAL_PLEDGES: Pledge[] = [
  { _id: 'p1', donorName: 'Robert Brown', donorId: 'd1', amount: 5000, fundId: 'f2', frequency: 'One-off', startDate: '2023-01-01', status: 'Active' },
  { _id: 'p2', donorName: 'Sarah Jenkins', donorId: 'd2', amount: 200, fundId: 'f2', frequency: 'Monthly', startDate: '2023-01-01', endDate: '2024-12-31', status: 'Active' },
  { _id: 'p3', donorName: 'Anonymous Donor', donorId: 'd4', amount: 10000, fundId: 'f2', frequency: 'One-off', startDate: '2023-06-01', status: 'Completed' },
  { _id: 'p4', donorName: 'James Wilson', donorId: 'd5', amount: 50, fundId: 'f1', frequency: 'Monthly', startDate: '2023-01-01', status: 'Active' },
];
